import pytest
from description import User, PasswordValidator, UsernameValidator
...
def test_username_validator_methods():
    ...
    assert hasattr(username_validator, '__get__'), "UsernameValidator should have '__get__' method"
    assert hasattr(username_validator, '__set__'), "UsernameValidator should have '__set__' method"

def test_password_validator_methods():
    password_validator = PasswordValidator()
    assert hasattr(password_validator, '__get__'), "PasswordValidator should have '__get__' method"
    assert hasattr(password_validator, '__set__'), "PasswordValidator should have '__set__' method"